...
const Expriences = () => {
  ...
  return (
    <section className="px-6 py-10" id="experience">
        ...
        <motion.div className="space-y-10" initial = "hidden" whileInView="visible" viewport={{once: true, amount: 0.3}} variants={containerVariants}>{EXPERIENCES.map((exprience, index) => (
