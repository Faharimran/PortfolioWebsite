...
import person1 from "/src/assets/person1.jpeg";
...
export const HERO_CONTENT = {
  greeting: "Hey there! 💃🏼",
  introduction:
    "I'm Fahar Imran, a creative developer, crafting immersive and intuitive web experiences.",
  description:
...
export const EXPERIENCES = [
  {
    ...
    location: "Remote",
    description: [
      "Worked as a web developer, and helped in all the technical aspects of the project.",
      "Helped in setting up the company's website.",
      "Driving innovation through continuous improvements in performance and UI/UX design.",
    ],
  },
  {
    yearRange: "Jan 2024 — June 2024",
    title: "IOS developer at Infosys.",  
    location: "Mysore, India",
    description: [
      "Lead of IOS development team.",
      "Worked on the development of IOS applications.",
      "Worked on the API's and backend development.",
    ],
  },
  {
    yearRange: "2023 — 2024",
    title: "Creative Lead of THM",
    location: "The Hackers Meetup, Noida",
    description: [
      "Part of the founders team of THM.",
      "Hosted several events for the hackers.",
      "Provided a platform for the hackers to connect with each other.",
    ],
  },
  {
    yearRange: "2022 — 2023",
    title: "Club head of the Club of Creatives",
    location: "Galgotias University, Greater Noida",
    description: [
      "Hosting the event for the art enthusiasts.",
      "Helping the nurd art techies who are so busy with their tech work to keep touch with their artistic side.",
      "Assisting the novice artists to get started with the art world.",
    ],
  },
...
export const CONTACT_CONTENT = {
  ...
  email: "faharshahid2004@gmail.com",
  socialLinks: [
    {
      platform: "Twitter",
    ...
    {
      platform: "GitHub",
      url: "https://github.com/Faharimran",
      ariaLabel: "View my GitHub profile",
      icon: "RiGithubFill",
    },
    {
      platform: "LinkedIn",
      url: "https://linkedin.com/in/fahar-imran-b3250b230/",
      ariaLabel: "Connect with me on LinkedIn",
      icon: "RiLinkedinFill",
    },
    {
      platform: "Instagram",
      url: "https://instagram.com/faharshahid123",
      ariaLabel: "Follow me on Instagram",
      icon: "RiInstagramFill",
    }
  ],
  footerText: `© ${new Date().getFullYear()} Fahar Imran. All rights reserved.`,
};
